...
# @pytest.mark.skip(reason="No way to test this feature yet")
def test_get_recipes_one_saved_recipe(client, one_user, one_recipe):
    # Act
    response = client.get("/recipes")
    response_body = response.get_json()
    ...
    assert new_recipe.shareAs == "https://www.whats-for-dinner.com/testitem"
    assert new_recipe.menu_date == "Aug 01 2022"
    assert new_recipe.favorite == False
    assert new_recipe.user_id == 1

# @pytest.mark.skip(reason="No way to test this feature yet")
def test_create_recipe(client, one_user):
    # Act
    response = client.post("/recipes", json={
        "hash": "6cddaef7d51e5ee16fd39363d2355286",
        "label": "Slow Cooker Chicken and Dumplings",
        "shareAs": "https://www.whats-for-dinner.com/testitem",
...
# @pytest.mark.skip(reason="No way to test this feature yet")
def test_get_specific_recipe(client, one_user, one_recipe):
    # Act
...
# @pytest.mark.skip(reason="No way to test this feature yet")
def test_delete_specific_recipe(client, one_user, one_recipe):
    # Act
    response = client.delete("recipes/1/users/1")
    response_body = response.get_json()
