...
def one_user(app):
    new_user = User(
        name="Shayla Logan", email="shayla.logan709@gmail.com")
...
def one_item(app):
    new_item = Shopping_list(
        item="sliced cheese", completed=False, uid=1)
...
def one_user_recipe(app, one_user, one_recipe):
    new_user_recipe = UserRecipe(
        rhash="6cddaef7d51e5ee16fd39363d2355286", uid=1, favorite=True, menu_date="Aug 01 2022")
