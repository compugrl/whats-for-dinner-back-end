...
def one_user(app):
    new_user = User(
        name="Shayla Logan", email="shayla.logan709@gmail.com", days_to_display=1, menu_date="Mon, 25 Jul 2022",
        favorite=True)
